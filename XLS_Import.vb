...
Public Class XLS_Import
    ...
    'Dim datafile As String = IO_Reader_Writer.doc1dong(Application.StartupPath + "\myFile.dll", 1) 'File.dll là file text lưu đường dẫn file dữ liệu tại dòng đầu
    ...
    Dim datafile As String = "D:\Working\TayNguyen\Tinh toan Chi tieu\Du Lieu sau TD 2014_avg0812.xlsx"
    Dim myConnectString As String = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source= " + datafile + ";Extended Properties='Excel 12.0 Xml;HDR=YES';"
    Public myConnection As New OleDbConnection(myConnectString) ' Bi?n th?c thi k?t n?i v?i CSDL
